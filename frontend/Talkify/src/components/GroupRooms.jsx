  ...
  return (
    <div key={room._id}>
      {room.members.some((member) => member.user === userId) ? (
        <li
          className={`bg-white hover:bg-gray-200 rounded-lg flex justify-between items-baseline space-x-2 px-5 py-4 shadow-md transition ease-in-out duration-500 cursor-pointer dark:bg-[#20212c] hover:bg-[#635fc71a] hover:text-[#635fc7] dark:hover:bg-white dark:hover:text-[#635fc7] dark:text-white`}
